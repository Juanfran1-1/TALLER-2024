...
function buscarcantidad2(a:arbol;min,max:integer):integer;
begin 
  ...
  if (a=nil) then 
    buscarcantidad2:= 0
        ...
        if (min <= a^.dato.cod) 
          if (max >= a^.dato.cod) then 
              buscarcantidad2:=  1 + buscarcantidad2(a^.HI,min,max) + buscarcantidad2(a^.HD,min,max)
          else           
            buscarcantidad2:=buscarcantidad2(a^.HI,min,max)
        else
            buscarcantidad2:=buscarcantidad2(a^.HD,min,max);
end; 
