...
un nombre y están formados por un director y una serie de coristas. Del director se conoce el nombre, DNI, edad y la antigüedad (un número entero). 
De los coristas se conoce el nombre, DNI, edad y el tono fundamental (un número entero). Asimismo, hay dos tipos
de coros: coro semicircular en el que los coristas se colocan en el escenario uno al lado del
otro y coro por hileras donde los coristas se organizan en filas de igual dimensión.
...
o En el coro semicircular los coristas se deben ir agregando de izquierda a
derecha
...
public class Practica5eje4 {

    public static void main(String[] args) {
        
        Director direc1 = new Director("Matias", 555, 18,3);
        CoroS corosemic = new CoroS("CoroSemic",direc1, 4 );
        Corista corista1 = new Corista("Pepe", 333, 3 ,4444);
        Corista corista2 = new Corista("Juan", 444, 2,5555);
        Corista corista3 = new Corista("Rocio", 666, 1,6666);
        ...
        System.out.println(corosemic.bienOrdenado());
        
        System.out.println("-------------------");
        
        Director direc2 = new Director("Lucio", 222, 21,2);
        CoroH corohil = new CoroH("CoroHileras",direc2, 4, 2, 3);
        Corista corista4 = new Corista("Gonzalo", 542, 3,333);
        Corista corista5 = new Corista("Veronica", 324, 3,333);
        Corista corista6 = new Corista("Laura", 675, 3,333);
        Corista corista7 = new Corista("Eduardo", 338, 1,666);
        Corista corista8 = new Corista("Victoria", 427, 1,666);
        Corista corista9 = new Corista("Cecilia", 926, 1,666);
        ...
        System.out.println(corohil.bienOrdenado());
